    ...
    const createGemElement = (gem) => {
        ...
        if (gem.name === '' || gem.isWithoutEffects) {
            ...
            const subOption1Text = gem.subOption1 && gem.subOption1Level
                ? `${getSubOptionDisplay(gem.subOption1)} Lv.${gem.subOption1Level}`
                : t('messages.gemWithoutEffects');
            const subOption2Text = gem.subOption2 && gem.subOption2Level
                ? `${getSubOptionDisplay(gem.subOption2)} Lv.${gem.subOption2Level}`
                : t('messages.gemWithoutEffects');
            detailsHtml = `
                <div class="gem-item-details">
    ...
    result.gems.forEach((gem, index) => {
        if (socketContainer.children[index]) {
            ...
            if (gem.name === '' || gem.isWithoutEffects) {
                ...
                const subOption1Text = gem.subOption1 && gem.subOption1Level ? `${gem.subOption1} Lv.${gem.subOption1Level}` : '';
                const subOption2Text = gem.subOption2 && gem.subOption2Level ? `${gem.subOption2} Lv.${gem.subOption2Level}` : '';
                subOptionsHtml = `
                    <div class="gem-item-sub-options">
